Clear.seed do
  ...
  p1 = Post.create!({title: "About poney", content: "Poney are cool", author: a1})
  p2 = Post.create!({title: "About dog and cat", content: "Cat and dog are cool. But not as much as poney", author: a1})
